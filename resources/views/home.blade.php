    ...
    <div class="container bg-light p-5" style="border-radius: 20px;">
        <div class="row my-5">
            <div class="col-md-6 d-flex align-items-center">
                <div>
                    <h2>Selamat Datang di Fans Page <br><b>Counter Strike Online Indonesia</b></h2>
                    <p class="text-secondary">Tempat berkumpulnya anggota Family Serui Indonesia, <br>Jangan ngaku Envi    kalo belum jadi Member</p>
